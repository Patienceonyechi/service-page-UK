  ...
  return (
    <div className='bg-white '>
        ...
        <div className=' flex bg-white w-screen h-screen mt-[70px] sm:w-screen sm:h-screen sm:flex-col sm:mt-[70px]'>
          ...
          <img
          className='w-[100%] h-[100%] object-cover' src= {pic}/>
          </div>
        </div>
        ...
        <div >
           ...
           <div className='flex justify-center border-[1px] gap-5 h-[100%] w-[90%] ml-[56px] sm:mx-auto sm:flex-wrap text-center mt-4 '>
             <div className='pt-5 p-4'>
              ...
              <div>
                <p className='text-center text-[16px] text-[#666666]'>A clean and hygieic offices is a more productive
                  place for your staff to work and a more pleasant
                  place for your for your client to visit.br We provide 
            ...
            <div className='border-x-[1px]'>
              ...
              <div className=''>
                <p className=' text-[16px] text-[#666666]'>A clean and hygieic offices is a more productive 
                  place for your staff to work and a more pleasant 
                  place for your for your client to visit.br We provide 
                  hight quality,cost effective office cleaning solution 
                  and currently work with a number of companies across lagos</p>
           ...
           src={pic4} />
            ...
            <div className='flex-col items-center '>
                ...
                <div className='sm:flex sm:flex-col sm:items-center'>
                  <h2 className='flex justify-center text-black font-bold text-[30px] sm:text-[15px]'>How it Work</h2>
                </div>
         ...
         <div> 
           <div className='flex  justify-center'>
            <div className='bg-[#1239ca] flex items-center  w-[90%] h-[530px] rounded-[10px] sm:w-screen sm:h-80 bg-cover bg-no-repeat'>
               <div className='bg-cover bg-no-repeat w-[55%] min-h-[80vh] py-20 relative  ' style={{backgroundImage:`url(${pic9})`}}>
               <img
